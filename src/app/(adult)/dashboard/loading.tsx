  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-6 animate-pulse">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="h-9 w-44 bg-slate-200 dark:bg-slate-800 rounded-xl" />
      </div>

      {/* Countdown banner skeleton */}
      <div className="mb-6 h-20 rounded-2xl bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-800" />
      ...
      {/* 20 Questions & Overdue skeleton */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="p-5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 h-64 space-y-3">
